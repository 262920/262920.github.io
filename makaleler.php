	...
	<div class=" container MarginTop_10 MarginBottom_10 " >
    	<div class="jumbotron PaddingBottom_20 PaddingTop_20 MarginBottom_0">
            <div class="page-header MarginTop_0 MarginBottom_0 PaddingBottom_0 PaddingTop_0">
            	<h2 class="MarginTop_0 MarginBottom_0">Makaleler</h2>
            </div>
    	</div>
    </div>
 	...
 	<div class="container">
      ...
      <!-- Makalelerin listeli menü tasarımı başladı -->       
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 hidden-xs padding_5">
                    ...
                    <?php for($kategori=0; $kategori<=10; $kategori++) { ?>
                    
                      <div class=" panel panel-default">
                     	 <div class="panel-heading" role="tab" id="headingOne">
      						<h4 class="panel-title">
                      			<a title="" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $kategori; ?>">PHP Dersleri</a>
                                <a class="pull-right tooltipAc" data-toogle="tooltip" href="makaleler-ana_kategori.php" title="Php Derslerini Listele"> <i class="glyphicon glyphicon-search"></i></a>
                         	</h4>
                       	 </div>
                      	<ul id="collapse<?php echo $kategori; ?>" class=" list-group collapseList in">
                        	<li class="list-group-item"><a href="makaleler-alt_kategori.php" title=""><i class="glyphicon glyphicon-minus"></i>PHP</a></li>
                            <li class="list-group-item"><a href="makaleler-alt_kategori.php" title=""><i class="glyphicon glyphicon-minus"></i>Panel</a></li>
                            <li class="list-group-item"><a href="makaleler-alt_kategori.php" title=""><i class="glyphicon glyphicon-minus"></i>Haber Sitesi </a></li>
                            <li class="list-group-item"><a href="makaleler-alt_kategori.php" title=""><i class="glyphicon glyphicon-minus"></i>Yok artık! </a></li>
                ...
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 padding_5">
                	...
                	<?php for($i=1; $i<=7; $i++) { ?>
                        ...
                        <div class=" FontSize_13 panel-body">
    						<a class=" img-thumbnail col-lg-3 col-md-3 col-sm-12 hidden-xs pull-right PaddingRight_0" href="makale-detay.php" title="">
                        ...
                        <div class="panel-footer">
                        	<ol class=" hidden-xs col-lg-10 col-md-9 col-sm-8 breadcrumb MarginBottom_0 Padding_0">
                              <li><a href="#">PHP Dersleri</a></li>
                              <li><a href="makaleler-alt_kategori.php">PHP</a></li>				
                            </ol>
                            <a class=" col-lg-2 col-md-3 col-sm-4 pull-right text-right" href="makale-detay.php" title=""><em>devamını oku..</em></a>

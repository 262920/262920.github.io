...
<meta http-equiv="content-type" content="text/html;charset=UTF-8"/>
    ...
    <![endif]-->
    <title>Tasarımcı Web || Videolar</title>
	...
	<div class=" container MarginTop_10 MarginBottom_10 " >
    	<div class="jumbotron PaddingBottom_20 PaddingTop_20 MarginBottom_0">
            <div class="page-header MarginTop_0 MarginBottom_0 PaddingBottom_0 PaddingTop_0">
            	<h2 class="MarginTop_0 MarginBottom_0">Videolar</h2>
            </div>
    	</div>
    </div>
 	...
 	<div class="container">
      ...
      <!-- Makalelerin listeli menü tasarımı başladı -->       
                      ...
                      <div class=" panel panel-default">
                     	 <div class="panel-heading" role="tab" id="headingOne">
      						<h4 class="panel-title">
                                ...
                                <a class="pull-right tooltipAc" data-toogle="tooltip" href="videolar-ana_kategori.php" title="Php Derslerini Listele"> <i class="glyphicon glyphicon-search"></i></a>
                         	</h4>
                       	 </div>
                      	<ul id="collapse<?php echo $kategori; ?>" class=" list-group collapseList in">
                        	<li class="list-group-item"><a href="videolar-alt_kategori.php" title=""><i class="glyphicon glyphicon-minus"></i>PHP</a></li>
                            <li class="list-group-item"><a href="videolar-alt_kategori.php" title=""><i class="glyphicon glyphicon-minus"></i>Panel</a></li>
                            <li class="list-group-item"><a href="videolar-alt_kategori.php" title=""><i class="glyphicon glyphicon-minus"></i>Haber Sitesi </a></li>
                            <li class="list-group-item"><a href="videolar-alt_kategori.php" title=""><i class="glyphicon glyphicon-minus"></i>Yok artık! </a></li>
       ...
       <!-- Makalelerin listeli menü tasarımı bitti -->     
                ...
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 padding_5 AnasayfaVideoListDiv">
